...
Customers | order by LastName | project name_abbr = strcat(substring(FirstName,0,3), ' ', substring(LastName,2));
print '';
print '-- Customers | project name = strcat(FirstName, \' \', LastName)';
Customers | order by LastName | project name = strcat(FirstName, ' ', LastName);
print '';
print '-- Customers | project FirstName, strlen(FirstName)';
Customers | order by LastName | project FirstName, strlen(FirstName);
print '';
print '-- Customers | project strrep(FirstName,2,\'_\')';
Customers | order by LastName | project strrep(FirstName,2,'_');
print '';
...
Customers | order by LastName | project toupper(FirstName);
print '';
print '-- Customers | project tolower(FirstName)';
Customers | order by LastName | project tolower(FirstName);
print '';
