...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        {
            "print tobool(A)",
            "SELECT multiIf(toString(A) = 'true', true, toString(A) = 'false', false, toInt64OrNull(toString(A)) != 0) AS print_0"
        },
        {
            "print toboolean(A)",
            "SELECT multiIf(toString(A) = 'true', true, toString(A) = 'false', false, toInt64OrNull(toString(A)) != 0) AS print_0"
        ...
        {
            "print todouble(A)",
            "SELECT toFloat64OrNull(toString(A)) / if(toTypeName(A) = 'IntervalNanosecond', 100, 1) AS print_0"
        },
        {
            "print toint(A)",
            "SELECT intDiv(toInt32OrNull(toString(A)), if(toTypeName(A) = 'IntervalNanosecond', 100, 1)) AS print_0"
        },
        {
            "print tolong(A)",
        ...
        {
            "print tostring(A)",
            "SELECT ifNull(kql_tostring(A), '') AS print_0"
        },
        {
            "print decimal(123.345)",
            "SELECT toDecimal128(CAST('123.345', 'String'), 32) AS print_0"
        },
        {
            "print decimal(NULL)",
