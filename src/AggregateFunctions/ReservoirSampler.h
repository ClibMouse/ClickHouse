...
public:
    ...
    {
        DB::readBinaryLittleEndian<size_t>(sample_count, buf);
        DB::readBinaryLittleEndian<size_t>(total_values, buf);
    ...
    {
        DB::writeBinaryLittleEndian<size_t>(sample_count, buf);
        DB::writeBinaryLittleEndian<size_t>(total_values, buf);
